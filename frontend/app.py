    ...
    if page == "Home":
        ...
        if not squad:
            ...
            if 'role' in df_team.columns:
                ...
                # Create pie chart for role percentages
                fig_role = px.pie(
        ...
        if len(st.session_state.selected_players) < 11:
            ...
            st.markdown("---")
            st.subheader("🎯 Best XI from Your Squad (Deep Learning Selection)")
                ...
                with st.spinner("Generating..."):
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            # Display playing XI in nice format
...
def render_team_optimization_page():
    """Render Team Optimization AI page with Deep Learning analysis"""
    ...
    if len(st.session_state.selected_players) < 11:
        ...
        if st.button("🤖 Run AI Optimization Analysis", type="primary"):
            with st.spinner("🧠 AI is analyzing your team..."):
                try:
                    # Send selected players to backend
                    payload = {
                    ...
                    if response.status_code == 200:
                        ...
                        # Handle 400 error with helpful message
